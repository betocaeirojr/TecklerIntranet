<html>
	<head>
		<title> Teckler - Google Analytics Comparison Report</title>
	</head>
	<body>
		<!-- Starting Scripts Definition -->
		<h1> Teckler Basic Google Analytics Comparion Reporting </h1>
		<h2> Please select what to compare:</h2>
		<form action="detailed_ga_comparison_report.php" method="post">
			<table border=1>
				<tr>
					<th colspan=2>&nbsp;Metric&nbsp;</th>
					<td colspan=2><select id="selected_metric" name="selected_metric">
				...
				<tr>
					...
					<td colspan=2><select id="selected_period" name="selected_period">
				...
				<tr>
					<td colspan=4 align="center"><input type="submit" name="cancel" value="Cancel"> &nbsp; <input type="submit" name="compare" value="Compare"></td>
				</tr>
			</table>
		</form>
		<hr>

<!-- Exibiting code starting -->
