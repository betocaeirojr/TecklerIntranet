...
$metrics = array('pageviews','uniquePageviews', 'bounces', 'pageviewsPerVisit', 'avgTimeOnPage', 'pageValue');
$sort = '-date';
	...
	<table border=1>
		...
		<tr> <!--  Any Given page on site -->	
			...
			<td><select name="landingpagepath_select" id="landingpagepath_select">
					<option value = "null" selected> Overall Info </option>
					<option value = "LandingPagePath =~ (..\/home)$">Home - All</option>
					<option value = "LandingPagePath == /pt/home">Home - Portugues </option>
					<option value = "LandingPagePath == /en/home">Home - English</option>
				</select>
			</td>
		</tr>
